...
// src/app/background.service.ts
var BackgroundService;
var init_background_service = __esm({
  "src/app/background.service.ts"() {
    "use strict";
    init_tslib_es6();
    init_core();
    BackgroundService = class BackgroundService2 {
      images = ["images/bg1.svg", "images/bg2.svg", "images/bg3.svg"];
      getSuggestions() {
        return this.images;
      }
      setBackground(url) {
...
var init_app3 = __esm({
  "src/app/app.ts"() {
    ...
    App = class App2 {
      ...
      router;
      bg;
      title = signal("Konzertkompass");
      constructor(auth, router, bg) {
        this.auth = auth;
        this.router = router;
        this.bg = bg;
